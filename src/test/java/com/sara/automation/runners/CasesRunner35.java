...
public class CasesRunner35 {
    // Establecer el numero del runner cuando se carga la clase
    static {
        System.out.println("====== CARGANDO CASESRUNNER35 ======");
        System.setProperty("runnerNumber", "35");
        System.out.println("====== SYSTEM PROPERTY ESTABLECIDO: runnerNumber=35 ======");
    }
}